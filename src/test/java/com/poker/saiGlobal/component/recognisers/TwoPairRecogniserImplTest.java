...
public class TwoPairRecogniserImplTest {

    @InjectMocks
    private TwoPairRecogniserImpl twoPairRecogniser;

    @Test
    public void recogniseTwoPair_Test () {
    ...
    public void recogniseTwoPair_Test_HighCard () {
        ...
        assertNotEquals(2, person.getHandValue());
    }
    ...
    @Test
    public void recogniseTwoPair_Test_ThreeOfKind () {
        List<Card> hand = new ArrayList<>();
        hand.add(new Card(2, Suit.CLUB));
        hand.add(new Card(2, Suit.DIAMOND));
        hand.add(new Card(2, Suit.CLUB));
